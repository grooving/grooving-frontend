export default{
    ...
    */
    ...
    image_help : "Must be a .png, .gif, .jpg or .jpeg image.",

    // ----------------------------------------------------
    //                EditProfileInfo.vue
    // ----------------------------------------------------

    profile_title : "Profile", // Se usa también en ReducedInfo.vue y ProfileInfo.vue
    profile_subtitle : "Basic info of your Grooving account, like your name and email.", // Se usa también en ProfileInfo.vue
    user_firstName : "FIRST NAME", // Se usa también en ReducedInfo.vue y ProfileInfo.vue
    user_lastName : "LAST NAME", // Se usa también en ReducedInfo.vue y ProfileInfo.vue
    user_artisticName : "ARTISTIC NAME", // Se usa también en ProfileInfo.vue
    user_username : "USERNAME", // Se usa también en ProfileInfo.vue
    ...
    add_carousel: "ADD", // Se usa también en EditImageCarousel.vue
    ...
    confirmation_title : "Are you sure that you want to delete your Grooving account?",
    confirmation_subtitle : "This operation cannot be undone.",
    cancel : "CANCEL",
    accept : "ACCEPT",
    ...
    terms_error: "You must accept our terms and conditions.", // Se usa también en CustomerRegister.vue
    phone_error: "The phone number must be between 600000000 and 999999999.", // Se usa también en CustomerRegister.vue
    ...
    customerRegister_uploadImage: 'Upload an image',
