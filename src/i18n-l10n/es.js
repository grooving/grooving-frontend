export default{
    ...
    /* 
        FORMATO:   entidadDelModelo + _ + nombreDelAtributo

        EJEMPLO DE FORMATO:
        customer_dateOfBirth : "Fecha de Nacimiento",
    ...
    */
    ...
    artist_description : "Biografía (1000 caracteres máx)",
    ...
    user_photo : "FOTO DE PERFIL", // Se usa también en ProfileInfo.vue
    user_newPassword: "NUEVA CONTRASEÑA",
    user_newPassword_placeholder: "Nueva contraseña",
    user_confirmPassword_placeholder: "Confirmar nueva contraseña",
    ...
    description_placeholder : "Añade aquí una descripción con información relevante sobre el evento. (500 caracteres máx)",
    ...
    aboutUs : "Quiénes Somos", // Se usa también en Footer.vue

    // ----------------------------------------------------
    //                 PaymentCode.vue
    // ----------------------------------------------------

    inputCode : "Introduzca el código",
    send : "ENVIAR",
    ...
    info_subtitle : "Información básica sobre el cliente",
    customer_zone : "ZONA",
    ...
    management_title : "Gestión de la Cuenta",
    deleteAccount : "ELIMINAR CUENTA",
    confirmation_title : "¿Está seguro de que quiere eliminar su cuenta de Grooving?",
    confirmation_subtitle : "Esta operación no puede deshacerse.",
    cancel : "CANCELAR",
    accept : "ACEPTAR",
    ...
    statistics_showLastMonth: "Último mes",
    statistics_showTotal: "Total",
    registered_artists: "Artistas Activos",
    registered_customers: "Clientes Activos",
    registers: "Usuarios",
    registers_lm: "Usuarios durante el Último mes",
    money_earned: "Dinero ganado",
    money_moved: "Dinero movido",
    money: "Dinero",
    money_lm: "Dinero durante el Último mes",
    accepted_offers_ratio: "Ratio de ofertas Aceptadas",
    rejected_offers_ratio: "Ratio de ofertas Rechazadas",
    pending_offers_ratio: "Ratio de ofertas Pendientes",
    paid_offers_ratio: "Ratio de ofertas Pagadas",
    ...
    event_data_error: 'Tienes que introducir información del evento',
